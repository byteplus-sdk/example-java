...
public final class Constant {
    //    public final static String LF_HOST = "124.238.238.229:80";
    public final static String LF_HOST = "10.1.57.26:5879";
    ...
    public final static String TOKEN = "fb541d45237fdd44b00255ba2ea77e48";

    //火山引擎申请的账号id/租户id(tenant_id)，如"2100021"
    public final static String TENANT_ID = "1";

    //个性化推荐服务新建的项目id(project_id)，如"1231314"
    public final static String PROJECT_ID = "10001292";
